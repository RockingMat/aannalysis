...
do 
    for type in ${types[@]}
    do
        # python src/acceptability.py -m kanishka/smolm-autoreg-bpe-counterfactual_babylm_aann_${variability}_variability_${type}-1e-3 -b 128 -a data/mahowald-aann
        python src/acceptability.py -m kanishka/smolm-autoreg-bpe-counterfactual_babylm_aann_${variability}_variability_${type}-seed_211-1e-3 -b 128 -a data/mahowald-aann
        python src/acceptability.py -m kanishka/smolm-autoreg-bpe-counterfactual_babylm_aann_${variability}_variability_${type}-seed_1024-1e-3 -b 128 -a data/mahowald-aann
    done
done